...
class Contents extends Component {
  ...
  onSelectIndex(event, { value }) {
    ...
    this.state.index.values[value].selected ? this.setState({tablewidthValue:this.state.tablewidthValue-10}) : this.setState({tablewidthValue:this.state.tablewidthValue+10})
    this.setState({
      index: newIndex,
    });
    console.log(this.state.widthValue);
                  ...
                  <section id="content-core">
                    <Segment.Group raised>
                      ...
                      <div className="contents-table-wrapper">
                        <Table style={{display:"inline block",width:`${this.state.tablewidthValue < 100 ? 100:this.state.tablewidthValue }%`}}selectable compact singleLine>
