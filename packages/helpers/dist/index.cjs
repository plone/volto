...
__export(index_exports, {
  InitAtoms: () => InitAtoms,
  applyStyleFieldDefaultsInData: () => applyStyleFieldDefaultsInData,
  findStyleDefinitionByName: () => findStyleDefinitionByName,
  flattenToAppURL: () => flattenToAppURL,
  getContentIcon: () => getContentIcon,
  getStyleFieldDefinitionsFromRegistry: () => getStyleFieldDefinitionsFromRegistry,
  getStyleFieldValue: () => getStyleFieldValue,
  getStyleFieldsFromBlockSchema: () => getStyleFieldsFromBlockSchema,
  getStyleFieldsFromSchema: () => getStyleFieldsFromSchema,
  hasBlocksData: () => hasBlocksData,
  isDeepEqual: () => isDeepEqual,
  isEmpty: () => isEmpty,
  isInternalURL: () => isInternalURL,
  langmap: () => langmap,
  resolveStyleFields: () => resolveStyleFields,
  setStyleFieldValue: () => setStyleFieldValue,
  useFieldFocusAtom: () => useFieldFocusAtom,
  useFieldFocusedAtom: () => useFieldFocusedAtom,
  useFieldValueFocusedAtom: () => useFieldValueFocusedAtom,
  useSetFieldFocusedAtom: () => useSetFieldFocusedAtom
});
...
var InitAtoms = ({
  ...
  (0, import_utils.useHydrateAtoms)(new Map(atomValues));
  return children;
};
function useFieldFocusAtom(anAtom, field) {
  return (0, import_jotai_optics.focusAtom)(
    anAtom,
    // @ts-expect-error https://github.com/jotaijs/jotai-optics/issues/6
    (0, import_react.useCallback)((optic) => optic.prop(field), [field])
  );
}
function useFieldFocusedAtom(atom, field) {
  return (0, import_jotai.useAtom)(
...
function useSetFieldFocusedAtom(atom, field) {
  return (0, import_jotai.useSetAtom)(
    (0, import_jotai_optics.focusAtom)(
      atom,
      // @ts-expect-error https://github.com/jotaijs/jotai-optics/issues/6
      (0, import_react.useCallback)(
...
// src/contents.ts
var import_registry = __toESM(require("@plone/registry"), 1);
var getContentIcon = (contentType, isFolderish = false) => {
  const { settings } = import_registry.default;
...
var import_registry2 = __toESM(require("@plone/registry"), 1);
function flattenToAppURL(data) {
  let stringData = JSON.stringify(data);
  stringData = stringData.replaceAll(`${import_registry2.default.settings.apiPath}/`, "/");
  stringData = stringData.replaceAll(import_registry2.default.settings.apiPath, "/");
  return JSON.parse(stringData);
}

// src/isInternalURL.ts
var import_registry3 = __toESM(require("@plone/registry"), 1);
function isInternalURL(url) {
  if (!url) return false;
  if (url.startsWith("/") || url.startsWith(".") || url.startsWith("#")) {
    return true;
  }
  const settings = import_registry3.default.settings ?? {};
...
// src/styleFields.ts
var import_registry4 = __toESM(require("@plone/registry"), 1);
var config4 = import_registry4.default.getUtility ? import_registry4.default : import_registry4.default.default;
