...
For Tailwind 4, you need to point the `configFile` key to a Tailwind CSS file in your reference package.
...
If you develop in this monorepo by running `make install` in the root directory, the necessary configuration will be automatically generated for you in your {file}`.vscode/settings.json` file.
