...
One uses Tailwind CSS, and the other uses pure CSS.
The Tailwind CSS components are built using the Tailwind CSS utility classes.
The pure CSS components are built using the CSS rules provided in the package.

## Tailwind

This package provides a set of components that use Tailwind CSS utility classes.
