...
describe('AddonConfigurationRegistry - Project', () => {
  ...
  it('provides customization paths declared in a Volto project', () => {
    ...
    expect(reg.getProjectCustomizationPaths()).toStrictEqual({
      '@plone/volto/TSComponent':
        '/Users/sneridagh/Development/plone/volto/packages/volto/__tests__/fixtures/test-volto-project/src/customizations/TSComponent.jsx',
      '@plone/volto/client': `${base}/src/customizations/client.js`,
      '@plone/volto/routes':
        '/Users/sneridagh/Development/plone/volto/packages/volto/__tests__/fixtures/test-volto-project/src/customizations/routes.tsx',
  ...
  it('provides customization paths declared in addons', () => {
    ...
    expect(reg.getAddonCustomizationPaths()).toStrictEqual({
      '@plone/volto/TSComponent':
        '/Users/sneridagh/Development/plone/volto/packages/volto/__tests__/fixtures/test-volto-project/node_modules/test-released-source-addon/src/customizations/TSComponent.jsx',
      '@plone/volto/client': `${base}/node_modules/test-released-source-addon/src/customizations/client.js`,
      '@plone/volto/routes':
        '/Users/sneridagh/Development/plone/volto/packages/volto/__tests__/fixtures/test-volto-project/node_modules/test-released-source-addon/src/customizations/routes.tsx',
