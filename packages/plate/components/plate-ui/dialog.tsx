  ...
  ({ children, className, ...props }, ref) => (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          `
            data-[state=open]:slide-in-from-top-48% data-[state=open]:animate-in
            data-[state=open]:fade-in-0 data-[state=open]:slide-in-from-left-1/2
            data-[state=open]:zoom-in-95
            data-[state=closed]:slide-out-to-top-48% data-[state=closed]:animate-out
