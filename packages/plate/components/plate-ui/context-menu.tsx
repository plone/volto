...
>(({ className, ...props }, ref) => (
  <ContextMenuPrimitive.SubContent
    ...
    className={cn(
      `
        z-50 min-w-32 overflow-hidden rounded-md border bg-popover py-1.5 text-popover-foreground
        shadow-md
...
>(({ className, ...props }, ref) => (
  <ContextMenuPrimitive.Portal>
    <ContextMenuPrimitive.Content
      ...
      className={cn(
        `
          z-50 min-w-32 overflow-hidden rounded-md border bg-popover text-popover-foreground
...
>(({ className, inset, ...props }, ref) => (
  <ContextMenuPrimitive.Item
    ...
    className={cn(
      `
        relative mx-1 flex h-[28px] cursor-default items-center rounded-sm px-2 text-sm
