...
import { Button } from '@plone/plate/components/plate-ui/button';
import {
  Command,
  CommandEmpty,
  CommandGroup,
  ...
  CommandItem,
  CommandList,
} from '@plone/plate/components/plate-ui/command';
import {
  Dialog,
  DialogContent,
  DialogDescription,
  ...
  DialogTitle,
  DialogTrigger,
} from '@plone/plate/components/plate-ui/dialog';
import { Input } from '@plone/plate/components/plate-ui/input';
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
} from '@plone/plate/components/plate-ui/popover';
