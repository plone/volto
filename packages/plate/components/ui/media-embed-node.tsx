                ...
                isYoutube ? (
                  <LiteYouTubeEmbed
                    ...
                    wrapperClass={cn(
                      ...
                      `
                        relative block cursor-pointer bg-black bg-cover bg-center
                        [contain:content]
                      `,
                      `
                        [&.lyt-activated]:before:absolute [&.lyt-activated]:before:top-0
                        [&.lyt-activated]:before:h-[60px] [&.lyt-activated]:before:w-full
                        [&.lyt-activated]:before:bg-top [&.lyt-activated]:before:bg-repeat-x
                      ...
                      `
                        [&_>_iframe]:absolute [&_>_iframe]:top-0 [&_>_iframe]:left-0
                        [&_>_iframe]:size-full
                      `,
                      `
                        [&_>_.lty-playbtn]:z-1 [&_>_.lty-playbtn]:h-[46px]
                        [&_>_.lty-playbtn]:w-[70px] [&_>_.lty-playbtn]:rounded-[14%]
                      ...
                      `,
                      `
                        [&_>_.lty-playbtn]:absolute [&_>_.lty-playbtn]:top-1/2
                        [&_>_.lty-playbtn]:left-1/2
                        [&_>_.lty-playbtn]:[transform:translate3d(-50%,-50%,0)]
                      `,
                      `
                        [&_>_.lty-playbtn]:before:absolute [&_>_.lty-playbtn]:before:top-1/2
