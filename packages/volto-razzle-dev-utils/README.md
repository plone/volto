> [!IMPORTANT]
> This package is a maintained fork of the original [razzle-dev-utils](https://github.com/jaredpalmer/razzle/tree/master/packages/razzle-dev-utils).
...
```js
const FriendlyErrorsPlugin = require('@plone/razzle-dev-utils/FriendlyErrorsPlugin');
...
```js
// razzle.config.js
const loaderFinder = require('@plone/razzle-dev-utils/makeLoaderFinder');
