...
const Logo = (props) => {
  var _a, _b;
  const { content } = props;
  const intl = src_default.getUtility({
    name: "translation",
    type: "factory"
  }).method;
  const navRootPath = ((_b = (_a = content["@components"].navroot) == null ? void 0 : _a.navroot) == null ? void 0 : _b["@id"]) || "/";
  const site = content["@components"].site;
  const siteTitle = (site == null ? void 0 : site["plone.site_title"]) || "";
  const logoUrl = (site == null ? void 0 : site["plone.site_logo"]) ? site["plone.site_logo"] : LogoImage;
  return /* @__PURE__ */ jsxRuntimeExports.jsx($4f118338184dc1d9$export$a6c7ac8248d6e38a, { href: navRootPath, "aria-label": intl(messages.home), className: "logo", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logoUrl, alt: intl(messages.logoOf) + " " + siteTitle }) });
};
try {
  Logo.displayName = "Logo";
  Logo.__docgenInfo = { "description": "", "displayName": "Logo", "props": { "content": { "defaultValue": null, "description": "", "name": "content", "required": true, "type": { "name": "Content" } }, "location": { "defaultValue": null, "description": "", "name": "location", "required": true, "type": { "name": "Location<any>" } }, "navRoot": { "defaultValue": null, "description": "", "name": "navRoot", "required": false, "type": { "name": "Content" } } } };
