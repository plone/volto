...
Allthough we install and use yarn, the create-volto-app tool still needs to be installed
using npm -g because yarn has a different implementation of global installs.
