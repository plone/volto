...
- [German Aerospace Center (DLR)](https://dlr.de) (The German Aerospace Center (DLR) is the Federal Republic of Germany's research center for aeronautics. With approximately 10.000 employees and a yearly budget of more than 1 billion euros per year, it is one of the largest research institutions in Germany, developed by [kitconcept GmbH](https://kitconcept.com), 2023)
