...
class Contents extends Component {
  ...
  constructor(props) {
    ...
    this.uppy = new Uppy().use(ContentsUploadPlugin, {
  ...
  onDrop = async (files) => {
    ...
    Promise.all(map(files, (file) => readAsDataURL(file))).then((dataFiles) => {
                        ...
                        {({ getRootProps, getInputProps }) => (
                          <div
                            {...getRootProps({
                              ...
                              style: {
                                borderStyle: this.state.draggingFiles
                                  ? 'solid'
                                  : 'none',
                              },
                            })}
