...
import ObjectBrowserNavComponent from './ObjectBrowserNav';
import { RealStoreWrapper as Wrapper } from '@plone/volto/storybook';

const IntlObjectBrowserNavComponent = injectIntl(ObjectBrowserNavComponent);
...
export const ObjectBrowserNav = StoryComponent.bind({});

export default {
  title: 'Internal Components/Sidebar/ObjectBrowserNav',
  component: ObjectBrowserNav,
  decorators: [
    (Story) => (
