...
<>
  <p>Render a right-side sidebar. Mainly used to edit block settings and
  documents metadata (in the case of composite pages, with blocks).
  Use the controls to toggle the open state.
  </p>
  <SidebarPopup {...args}>
