 ...
 * @module components/manage/Controlpanels/SiteControlpanel
 */
...
/**
 * SiteControlpanelComponent class.
 * @class SiteControlpanel
 * @extends Component
 */
class SiteControlpanel extends Component {
  /**
   * Property types.
  ...
  UNSAFE_componentWillMount() {
    this.props.getControlpanel('site');
  }
