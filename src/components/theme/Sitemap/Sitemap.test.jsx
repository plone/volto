...
describe('Sitemap', () => {
  it('renders a sitemap component', () => {
    const store = mockStore({
      navigation: {
        url: 'http://127.0.0.1:8080/Plone/@navigation',
        items: [
          {
            url: 'http://127.0.0.1:8080/Plone/page-1',
            description: '',
            items: [
              {
                url: 'http://127.0.0.1:8080/Plone/page-1/page-1-2',
                description: '',
                title: 'Page 1-2',
              },
              {
                url: 'http://127.0.0.1:8080/Plone/page-1/page-1-3',
                description: '',
                title: 'Page 1-3',
              },
            ],
          ...
          {
            url: 'http://127.0.0.1:8080/Plone/page-2',
            description: '',
            title: 'Page 2',
          },
        ],
