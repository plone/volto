...
const ConnectionRefused = () => (
  ...
  >
    ...
    {__DEVELOPMENT__ && (
      ...
      >
        <FormattedMessage
          id="The backend is not responding, please check if you have started Plone, check your project's configuration object API_PATH or the RAZZLE_API_PATH Volto's enviroment variable."
          defaultMessage="The backend is not responding, please check if you have started Plone, check your project's configuration object API_PATH or the RAZZLE_API_PATH Volto's enviroment variable."
        />
      </p>
    )}
    {!__DEVELOPMENT__ && (
