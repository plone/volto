describe('Link Integrity View for different content types', () => {
  ...
  it.only('As editor I get warning on deleting my page when my page is referenced in the richtext', () => {
    cy.createContent({
    ...
    cy.visit('/contents');
    cy.get('[aria-label="/page-will-be-linked"] > :nth-child(2)').click();
    cy.get('[aria-label="Delete"]').click();

    //TODO: check if 1. modal appears, 2. contains the correct link
  });
