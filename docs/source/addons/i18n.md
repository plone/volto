...
If you have multiple add-ons installed in your project, the translations are loaded in the order of add-ons' definitions, so the last defined add-on wins.
