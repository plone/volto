...
If you use the Docker image [`plone-backend`](https://github.com/plone/container-backend), you can set its `SITE_DEFAULT_LANGUAGE` environment variable, overriding the default of `en`, when you start it.
