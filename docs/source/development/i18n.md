...
As the name of this component suggests, it's also possible to format your messages as you prefer.
...
As `FormattedMessage` is only suitable for creating text within HTML elements, it cannot be used for translating individual attributes.
