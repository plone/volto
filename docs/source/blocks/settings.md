...
To extend the default set of blocks, add the following lines to your package's configuration file, for example, {file}`frontend/packages/volto-project-title/src/index.js`.
